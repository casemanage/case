 ...
 <div class="container">
 	<div class="Nav">
         <ul class="list-group">
             ...
             <li><a  A="frame-1" class="link-primary"><div class="containner-fluid" onclick="window.location.href='${pageContext.request.contextPath}/Home/statisticInfo.do'">概况</div></a></li>
             ...
             <li><a  A="frame-2" class="link-primary"><div class="containner-fluid" onclick="window.location.href='${pageContext.request.contextPath}/person/personList.do'">重点人员管理</div></a></li>
             ...
             <li><a  A="frame-4" class="link-primary"><div class="containner-fluid" onclick="window.location.href='${pageContext.request.contextPath}/associate/personCarList.do'">重点人员车辆管理</div></a></li>
         </ul>
     </div>
 </div>
